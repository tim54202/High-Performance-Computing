...
void rowBlockParallelCollective(CSR csrMatrix, double** vector, double* result, int startRow, int endRow, int vectorCols) {
...
int main(int argc, char* argv[]) {
    ...
    rowBlockParallelCollective(csrMatrix, vector, localResult, startRow, endRow, vectorCols);
