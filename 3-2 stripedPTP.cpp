...
void stripedPTP(CSR csrMatrix, double** vector, double* result, int rank, int size, int vectorCols) {
...
int main(int argc, char* argv[]) {
    ...
    stripedPTP(csrMatrix, vector, localResult, startRow, endRow, vectorCols);
