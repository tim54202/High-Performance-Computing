...
void rowWiseParallelPTP(CSR csrMatrix, double** vector, double* result, int startRow, int endRow, int vectorCols) {
...
int main(int argc, char* argv[]) {
    ...
    rowWiseParallelPTP(csrMatrix, vector, localResult, startRow, endRow, vectorCols);
