...
void rowWiseParallelCollective(CSR csrMatrix, double** vector, double* result, int startRow, int endRow, int vectorCols) {
    int localRowSize = endRow - startRow;

    for (int i = 0; i < localRowSize * vectorCols; i++) {
        result[i] = 0.0;
    }
...
int main(int argc, char* argv[]) {
    ...
    rowWiseParallelCollective(csrMatrix, vector, localResult, startRow, endRow, vectorCols);
